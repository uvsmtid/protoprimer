...
class ThisTestClass(BasePyfakefsTestClass):
    ...
    def test_failure_on_absolute_path(
        ...
        client_conf_file_data = {
            ConfField.field_client_default_target_dir_rel_path.value: "/abs/path",
        }
        mock_state_client_conf_file_data.return_value = client_conf_file_data
    ...
    def test_failure_on_path_with_dot_dot(
        ...
        client_conf_file_data = {
            ConfField.field_client_default_target_dir_rel_path.value: "conf/../bad",
        }
        mock_state_client_conf_file_data.return_value = client_conf_file_data
    ...
    def test_failure_on_non_directory_path(
        ...
        client_conf_file_data = {
            ConfField.field_client_default_target_dir_rel_path.value: "not_a_dir",
        }
        mock_state_client_conf_file_data.return_value = client_conf_file_data
    ...
    def test_failure_on_non_existent_path(
        ...
        client_conf_file_data = {
            ConfField.field_client_default_target_dir_rel_path.value: "missing_dir",
        }
        mock_state_client_conf_file_data.return_value = client_conf_file_data
    ...
    def test_success_on_symlink_leading_to_a_dir(
        ...
        client_conf_file_data = {
            ConfField.field_client_default_target_dir_rel_path.value: "symlink_to_dir",
        }
        mock_state_client_conf_file_data.return_value = client_conf_file_data
