...
from protoprimer.primer_kernel import (
    ArgConst,
    Bootstrapper_state_env_conf_dir_abs_path_local,
...
class ThisTestClass(BasePyfakefsTestClass):
    ...
    @patch(
        f"{primer_kernel.__name__}.{Bootstrapper_state_env_conf_dir_abs_path_local.__name__}.bootstrap_state"
    )
    @patch(
    ...
    def test_success_when_conf_symlink_exists_and_target_dst_dir_unspecified(
        ...
        mock_state_env_conf_dir_abs_path_local,
    ):
        ...
        mock_state_env_conf_dir_abs_path_local.return_value = (
        ...
        mock_state_args_parsed.return_value = argparse.Namespace(
            **{
                ArgConst.name_target_env_dir_rel_path: None,
                ArgConst.name_py_exec: PythonExecutable.py_exec_unknown.name,
                ArgConst.name_client_ref_dir_path: mock_client_dir,
            },
        )
    ...
    def test_success_when_conf_symlink_exists_and_target_dst_dir_matches(
        ...
        mock_state_args_parsed.return_value = argparse.Namespace(
            **{ArgConst.name_target_env_dir_rel_path: target_dst_dir_path},
        )
    ...
    def test_failure_when_conf_symlink_exists_but_target_dst_dir_mismatches(
        ...
        mock_state_args_parsed.return_value = argparse.Namespace(
            **{ArgConst.name_target_env_dir_rel_path: expected_target_dir},
        )
    ...
    def test_failure_when_conf_symlink_is_not_directory(
        ...
        mock_state_args_parsed.return_value = argparse.Namespace(
            **{ArgConst.name_target_env_dir_rel_path: mock_not_a_dir},
        )
    ...
    def test_failure_when_conf_is_not_symlink(
        ...
        self.fs.create_dir(state_env_conf_dir_abs_path_local)
        client_script_basename = "client_script.py"
        test_args = [
            client_script_basename,
        ]
    ...
    def test_success_when_conf_symlink_is_created_if_it_is_missing_and_target_dir_is_given(
        ...
        self.assertTrue(os.path.islink(state_env_conf_dir_abs_path_local))
        self.assertEqual(
            os.readlink(state_env_conf_dir_abs_path_local),
            target_dst_dir_path,
        )
    ...
    def test_success_when_conf_symlink_is_created_with_normalized_target(
        ...
        mock_state_args_parsed.return_value = argparse.Namespace(
            **{
                ArgConst.name_target_env_dir_rel_path: target_dst_dir_path_non_normalized
            },
        )
        state_env_conf_dir_abs_path_local = os.path.join(
            mock_client_dir,
