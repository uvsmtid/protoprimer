...
class ThisTestClass(BasePyfakefsTestClass):
    ...
    @patch(
        f"{primer_kernel.__name__}.{Bootstrapper_state_input_proto_conf_primer_file_abs_path_eval_finalized.__name__}._bootstrap_once"
    )
    def test_conf_file_exists(
        ...
        result = self.env_ctx.bootstrap_state(EnvState.state_proto_conf_file_data.name)
