...
class ThisTestClass(BasePyfakefsTestClass):
    ...
    def test_success_on_path_to_curr_python_is_outside_of_path_to_venv_when_venv_is_created(
        ...
        mock_state_local_venv_dir_abs_path_inited.return_value.eval_own_state.return_value = os.path.join(
        ...
        self.env_ctx.state_graph.eval_state(
            EnvState.state_stride_py_venv_reached.name, self.env_ctx
        )
    ...
    def test_failure_when_reusing_existing_venv_of_wrong_type(
        ...
        mock_state_venv_driver_prepared.return_value.eval_own_state.return_value = (
            VenvDriverPip(
                test_python_abs_path,
                test_python_version,
                path_to_venv,
