...
@patch(
    f"{primer_kernel.__name__}.{Bootstrapper_state_venv_driver_inited.__name__}.create_state_node"
)
@patch(
    f"{primer_kernel.__name__}.{Bootstrapper_state_reinstall_triggered.__name__}.create_state_node"
)
@patch(
    f"{primer_kernel.__name__}.{Bootstrapper_state_local_cache_dir_abs_path_inited.__name__}.create_state_node"
)
@patch(
    "protoprimer.primer_kernel.Bootstrapper_required_python_version_inited.create_state_node"
)
@patch(
...
def test_pip_driver_inited(
    ...
    mock_state_venv_driver_inited.return_value.eval_own_state.return_value = (
        VenvDriverType.venv_pip
    )
    ...
    mock_state_reinstall_triggered.return_value.eval_own_state.return_value = False
