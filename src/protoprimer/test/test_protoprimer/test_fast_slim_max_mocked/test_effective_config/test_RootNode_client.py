...
leap_client = (
    ...
    {{
        ...
        {TermColor.config_comment.value}# See `state_primer_conf_client_dir_abs_path_eval_finalized` in `derived` - normally, the resolved local config dir contains all local environment-specific config files.{TermColor.reset_style.value}
...
leap_client = (
    ...
    {{
        ...
        {TermColor.config_missing.value}# See `state_primer_conf_client_dir_abs_path_eval_finalized` in `derived` - normally, the resolved local config dir contains all local environment-specific config files.{TermColor.reset_style.value}
