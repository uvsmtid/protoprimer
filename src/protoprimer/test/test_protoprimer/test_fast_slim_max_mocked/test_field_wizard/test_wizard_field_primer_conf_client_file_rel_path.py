...
def test_relationship():
    assert_test_module_name_embeds_str(
        ConfField.field_primer_conf_client_file_rel_path.name
    )


@pytest.mark.parametrize(
    "test_line_no, user_input_lines, expected_field_value, expected_stdout_lines",
    [
        (
            line_no(),
            [
            ...
            [
                ...
                "progress",
                "progress",
                "Field: primer_conf_client_file_rel_path",
                "Description:",
                "Enter",
                "The relative path",
                "Confirming...",
...
def test_wizard_confirm_single_value_field_primer_conf_client_file_rel_path(
    ...
    file_data = {
        ...
        ConfField.field_primer_conf_client_file_rel_path.value: "old_client_conf",
    }

    wizard_meta = WizardField.field_primer_conf_client_file_rel_path.value
    ...
    expected_file_data = {
        ConfField.field_primer_ref_root_dir_rel_path.value: "old_ref_root",
        ConfField.field_primer_conf_client_file_rel_path.value: expected_field_value,
    }
