...
class StateMeta(enum.Enum):
    ...
    state_is_app_defined = StateNodeMeta(
    ...
    state_input_exec_operation_loaded = StateNodeMeta(
    ...
    state_python_selector_file_abs_path_inited = StateNodeMeta(
    ...
    state_start_executed = StateNodeMeta(
