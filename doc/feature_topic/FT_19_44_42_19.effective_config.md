...
To make it easily comprehensible, the `protoprimer` supports `config` exec mode to print annotated effective config:
*   annotated: each config field is printed with its description
