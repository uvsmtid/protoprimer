...
This requires an abs path to [proto_kernel][FT_87_17_49_36.proto_kernel.md].

At the same time, due to [context_isolation][FT_66_02_54_56.context_isolation.md],
`PROTOPRIMER_PROTO_KERNEL` env var is removed before passing control to any client code.
This is correct as env vars leak to child processes
(and `PROTOPRIMER_PROTO_KERNEL` will unintentionally affect any other `protoprimer` code started subsequently).

To pass the knowledge of the [proto_kernel][FT_87_17_49_36.proto_kernel.md] abs path to
