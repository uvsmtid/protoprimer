...
# FT_44_72_60_67.python_vs_shell

Eliminating the need to write shell-scripts is a side goal of `protoprimer`.

See also [the motivation section][protoprimer-motivation] in the main [readme.md][readme.md].
...
Essentially, a shell script is what a human would type interactively.
This implies succinct syntax (and may seem helpful, but quickly becomes cryptic).

[readme.md]: ../../readme.md
[protoprimer-motivation]: ../../readme.md#protoprimer-motivation
