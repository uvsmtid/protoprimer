...
*   `app` = application
    ...
    Effectively, the script has to execute `primer_main` function from `proto_code` (see `protoprimer.primer_kernel`).
    See [FT_58_74_37_70.starter_vs_bootstrapper.md][FT_58_74_37_70.starter_vs_bootstrapper.md].
...
TODO: Move this section to [FT_58_74_37_70.starter_vs_bootstrapper.md][FT_58_74_37_70.starter_vs_bootstrapper.md].
      Replace `app` or `lib` choice by `env_bootstrapper` or `app_starter`.
