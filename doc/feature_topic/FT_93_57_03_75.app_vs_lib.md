...
*   `app` = application
    ...
    one of the [exec_operation][FT_11_27_29_83.exec_operation.md].

    Effectively, the script has to execute `proto_main` function from `proto_kernel` (see `protoprimer.primer_kernel`).
    See [boot_vs_start][FT_58_74_37_70.boot_vs_start.md].

*   `lib` = library

    When `proto_kernel` is used as a library, the [entry_script][FT_75_87_82_46.entry_script.md]
    can use anything `proto_kernel` offers.
...
*   TODO: Should it be merged with [exec_mode][FT_31_04_70_72.exec_mode.md]?
...
[FT_85_17_35_21.call_lib.md]: FT_85_17_35_21.call_lib.md
