...
Ultimately, the symptom of the choice (whether `proto_kernel` is used as `boot_env` or `start_app`)
...
TODO: At the moment, `readme.md` explains both`./cmd/boot_env_example` and `./cmd/start_app_example`.

## See also

*   [entry_func][FT_25_62_13_55.entry_func.md]
*   [exec_operation][FT_11_27_29_83.exec_operation.md]
