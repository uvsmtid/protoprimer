...
*   environment bootstrapper:
    ...
    The "env bootstrapper" is indicated by `EntryFunc.func_boot_env` (see [FT_11_27_29_83.exec_mode.md]).

*   application starter:

    Assume `venv` is prepared, switch to required `python` and start custom client main function.

    The "app starter" is indicated by `EntryFunc.func_start_app` (see [FT_11_27_29_83.exec_mode.md]).
