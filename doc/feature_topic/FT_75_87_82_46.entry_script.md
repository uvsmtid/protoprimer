...
*   they are outside of `venv` which makes it difficult to execute reliably
...
*   The fastest option is to use (generated) [shebang][shebang_wiki] pointing to a `python` binary from `venv`.
...
## Special case: running `proto_kernel` directly

It is possible to run `proto_kernel` as an entry script directly
(see min leaps shape in [tree_shape][FT_59_95_81_63.tree_shape.md]), for example:

```sh
./src/proto_code/proto_kernel.py -h
```
...
[FT_59_95_81_63.tree_shape.md]: FT_59_95_81_63.tree_shape.md
...
[UC_71_59_90_97.generated_entry_script.md]: ../use_case/UC_71_59_90_97.generated_entry_script.md
