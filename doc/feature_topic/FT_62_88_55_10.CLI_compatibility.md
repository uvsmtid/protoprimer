...
The identiticity is achieved by calling the same `parse_args` from `protoprimer.primer_kernel`.

This requirement does not apply to `start_app` function (see [start_app][FT_05_08_64_67.start_app.md]).

See [boot_vs_start][FT_58_74_37_70.boot_vs_start.md] for the differences between `boot_env` and `start_app`.
