...
# FT_89_41_35_82.conf_leap

## Intro

There are several configuration leaps used to load `protoprimer` configuration.
...
graph TD;
    ...
    conf_input -- "`./src/proto_code`" --> conf_primer;
...
Depending on the [tree_shape][FT_59_95_81_63.tree_shape.md], all configuration leaps
may be provided in a single file or separate ones.

[leap_primer]: https://github.com/uvsmtid/protoprimer/blob/main/src/proto_code/proto_kernel.json
[leap_client]: https://github.com/uvsmtid/protoprimer/blob/main/gconf/proto_kernel.json
[leap_env]: https://github.com/uvsmtid/protoprimer/blob/main/dst/default_env/proto_kernel.json
