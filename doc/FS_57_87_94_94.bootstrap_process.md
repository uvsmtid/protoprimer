...
The entire bootstrap process involves multiple concepts (multiple "dimensions"):
...
*   [FS_14_52_73_23.primer_phase.md][FS_14_52_73_23.primer_phase.md] that switches from `proto` to `venv`
